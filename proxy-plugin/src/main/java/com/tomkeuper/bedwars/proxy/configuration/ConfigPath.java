...
public class ConfigPath {
    ...
    public static final String LEVEL_CONFIGURATION_BAR_UNLOCK_COLOR = "levels-settings.progress-bar-unlocked-color";
    public static final String LEVEL_CONFIGURATION_BAR_LOCK_COLOR = "levels-settings.progress-bar-locked-color";
    public static final String LEVEL_CONFIGURATION_BAR_SYMBOL = "levels-settings.progress-bar-symbol";
    public static final String LEVEL_CONFIGURATION_DEFAULT_NAME = "levels-settings.default-name";
