...
public class English extends Language {
    public English() {
        ...
        yml.addDefault(Messages.COMMAND_PARTY_LIST_MESSAGE, Arrays.asList("&6▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬","&6Party Members ({size})","", " &eParty Leader: {owner}", " &eParty Members: {members}" , "&6▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬"));
        yml.addDefault(Messages.COMMAND_PARTY_LIST_MEMBER_LIST_ITEM, " &7- &6{member}");
